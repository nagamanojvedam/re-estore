...
const MessageCard = ({ message, page }) => {
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:shadow-md dark:border-gray-700 dark:bg-gray-800">
      ...
      <div className="flex items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <div className="mt-1 flex items-center gap-2">
            ...
            <span className="truncate text-gray-500 dark:text-gray-400">• {message.email}</span>
          </div>
        </div>
      ...
      <div className="mt-4">
        <div className="rounded-xl border border-blue-200/50 bg-blue-50 p-4 dark:border-blue-900/40 dark:bg-blue-900/20">
          <p className="whitespace-pre-wrap text-sm text-gray-900 dark:text-gray-100">
            {showFull || !isLong ? message.message : `${message.message.slice(0, 240)}…`}
          </p>
        ...
        {!replyOpen ? (
          ...
          <div className="rounded-xl border border-gray-200 p-3 dark:border-gray-700">
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-gray-300 bg-white p-2 text-sm text-gray-900 placeholder:text-gray-400 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:placeholder:text-gray-500"
