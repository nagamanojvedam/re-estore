    ...
    <div className="min-h-screen bg-gray-50 transition-colors duration-300 dark:bg-gray-950">
      <section className="section-padding">
        <div className="container-custom mx-auto max-w-lg">
          ...
          {order && !isLoading && (
            <div className="mt-6 rounded-lg border border-gray-200 bg-white p-6 text-left text-gray-800 shadow-lg dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100">
