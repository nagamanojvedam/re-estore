        ...
        <div className="container-custom mx-auto max-w-4xl">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              How personal information is collected, used, and protected when using these services.
            </p>
          ...
          <p className="mt-6 text-gray-700 dark:text-gray-300">
            Privacy is taken seriously. This policy explains what data is collected, why it’s
            collected, and the choices available regarding personal information.
          </p>
          ...
          <p className="mt-2 text-gray-700 dark:text-gray-300">
            Personal details such as name, email address, payment details (processed by trusted
            providers), device and usage data, and order history may be collected to operate and
            improve the service.
          </p>
          <ul className="mt-3 list-disc space-y-2 pl-6 text-gray-700 dark:text-gray-300">
            ...
            <li>Payment data: handled by payment gateways; no card data is stored on servers.</li>
          </ul>
          ...
          <ul className="mt-2 list-disc space-y-2 pl-6 text-gray-700 dark:text-gray-300">
            ...
            <li>To communicate important updates, including order and policy notices.</li>
            <li>To prevent fraud, secure accounts, and comply with legal obligations.</li>
          </ul>
          ...
          <p className="mt-2 text-gray-700 dark:text-gray-300">
            Information is retained only for as long as necessary to provide services, comply with
          ...
          {/* Security */}
          <h2 className="mt-10 text-lg font-semibold text-gray-900 dark:text-white">Security</h2>
          <p className="mt-2 text-gray-700 dark:text-gray-300">
            Industry-standard safeguards are used, including transport encryption and secure payment
            gateways. No method of transmission or storage is 100% secure, and reasonable measures
