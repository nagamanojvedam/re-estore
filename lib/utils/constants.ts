...
export const ENV = {
  ...
  APP_NAME: process.env.NEXT_PUBLIC_APP_NAME || 'EStore',
  APP_DESCRIPTION: process.env.NEXT_PUBLIC_APP_DESCRIPTION || 'Your Shopping Destination',
  ITEMS_PER_PAGE: parseInt(process.env.NEXT_PUBLIC_ITEMS_PER_PAGE) || 12,
